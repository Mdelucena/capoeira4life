...
const socialLinks = [
  { name: 'Instagram', href: INSTAGRAM_URL, icon: 'instagram' as const },
  { name: 'YouTube', href: YOUTUBE_URL, icon: 'youtube' as const },
  { name: 'WhatsApp', href: getWhatsAppUrl(), icon: 'whatsapp' as const },
]
...
function SocialIcon({ icon }: { icon: 'instagram' | 'youtube' | 'whatsapp' }) {
  if (icon === 'instagram') {
    return (
    ...
    <footer className="footer">
      <div className="footer__main container">
        ...
        <FadeIn className="footer__col" delay={80}>
          ...
          >
            <WhatsAppIcon className="footer__whatsapp-icon" />
            {WHATSAPP_DISPLAY}
          </a>
      ...
      <div className="footer__bar">
        <div className="container footer__bar-inner">
          <FadeIn className="footer__brand" delay={200}>
            ...
            <Link to="/capoeirinha" className="footer__logo-link">
              <img
                src={capoeirinhaLogo}
                alt={t('footer.capoeirinhaAlt')}
                className="footer__logo footer__logo--capoeirinha"
              />
            </Link>
            <Link to="/capoeira-nago" className="footer__logo-link">
              <img
